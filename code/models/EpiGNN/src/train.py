...
# Purpose: Accept JSON config path to use MExDataLoader with season-aware splits.
ap.add_argument('--mex_config', type=str, default='', help='path to MEx JSON config; uses MExDataLoader when set')
# End Adaptation
args = ap.parse_args()
print('--------Parameters--------')
print(args)
...
# MEx Thesis Adaptation - 2026-02-19
# Purpose: Route to MExDataLoader when --mex_config is provided.
if args.mex_config:
    data_loader = MExDataLoader(args.mex_config, cuda=args.cuda)
else:
